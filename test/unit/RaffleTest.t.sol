...
contract RaffleTest is CodeConstants, Test {
    ...
    function setUp() external {
        ...
        vrfCoordinator = networkConfig.vrfCoordinatorV2_5;
    ...
    function testDontAloowPlayersToEnterWhileRaffleIsCalculating() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
    ...
    function testCheckUpcheckReturnsFalseIfNoBalance() public {
        // Arrange
        vm.warp(block.timestamp + interval + 1);
        vm.roll(block.number + 1);
